...
def make_readme_md_file():
    ...
    for font_config in configs.font_configs:
        ...
        preview += f'[实时预览](https://retro-pixel-font.takwolf.com#font-{font_config.output_name}) · '
        preview += f'[字母表](https://retro-pixel-font.takwolf.com/{font_config.output_name}/alphabet.html) · '
        preview += f'[示例文本](https://retro-pixel-font.takwolf.com/{font_config.output_name}/demo.html)\n\n'
